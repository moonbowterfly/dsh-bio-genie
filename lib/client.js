 ...
 *   - **Skill tab**：调 GET /api/dsh-bio-genie/skills 拉主 skill + 40 领域/R/协议 +
...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var DEFAULT_CONFIG = [
      ...
      { key: 'warmUpR', value: 'false', desc: '是否预热 R 环境（默认关闭，惰性引导）' },
    ...
    var DOCS = [
      ...
      { label: '工具表', href: META.docsRoot + '/tools.md', note: '21 个语义化工具的字段与适用场景' },
